    ...
    <body>
        <div class="content">
            <div class="content-header">
                ...
                <!--button menu-->
                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false" style="pointer-events: none; display: block; width: 1.2%; height: auto;"><path d="M21 6H3V5h18v1zm0 5H3v1h18v-1zm0 6H3v1h18v-1z"></path></svg>

                <!--logo-->
                <svg xmlns="http://www.w3.org/2000/svg" class="external-icon" viewBox="0 0 90 20" focusable="false" style="pointer-events: none; display: block; width: 5%; height: auto;">
...
<!--            sign in button-->
            <button class="sign-in-button">
                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false" style="pointer-events: none; display: block; width: auto; height: auto;">
